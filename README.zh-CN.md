...
当前仓库目标为 **v0.1.0-alpha.1**。这是用于测试、反馈与互操作验证的预发布候选，不等同于稳定版或 1.0。正式发布前仍需要完成参考机长时间交互测试、安装/卸载验证、签名/公证与许可证等发布方决策。

详见 [Alpha 发布说明](docs/releases/v0.1.0-alpha.1.md) 与 [候选检查表](docs/releases/v0.1.0-alpha.1-CHECKLIST.md)。
